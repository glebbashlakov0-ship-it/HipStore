  ...
  function pickStrings(translations, language) {
    ...
    return {
      bidding: {
        ...
        thankYou: pick(["bidding", "thankYou"], "We have received your bid."),
        successEyebrow: pick(["bidding", "successEyebrow"], "Bid received"),
        successTitle: pick(["bidding", "successTitle"], "We have received your bid."),
        successMessage: pick(["bidding", "successMessage"], "Your bid is now active. We will notify you if you are outbid or if you win the lot."),
        ...
        successPending: pick(["bidding", "successPending"], "Active"),
