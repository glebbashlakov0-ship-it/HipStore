(function () {
  ...
  function renderCard(item) {
    ...
    return (
      ...
      "</span>" +
      '<h3 class="font-serif text-[10px] sm:text-xs leading-tight line-clamp-2 min-h-[28px] sm:min-h-[32px]">' +
      escapeHtml(item.title) +
  ...
  loadJson("../data/last-chance.json")
    ...
    .catch(function (error) {
      console.error("Last Chance render failed:", error);
    });
})();
